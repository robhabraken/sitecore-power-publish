...
If you are using Sitecore 7, this also works for datasource field values, as they are queryable or represented by GUIDs from version 7 and up. Older versions of Sitecore (6.6 and less) store datasources as plain text, hence they are not noted as reference by Sitecore and thus this plugin will not have any effect on those items.
